      ...
      <View>
        ...
        <View style={styles.wrap}>
          ...
          <P>
            ...
            you emails about our services, new products and other updates.
          </P>
          <BR />
          ...
          <P>
            ...
            then Stripe stores your credit card data. It is encrypted through
            ...
            <BR />
            For more insight, you may also want to read Stripe’s Terms of
          ...
          <P>
            ...
            you visit our services, and this may include using cookies or
            similar technologies to identify your browser or device. We also use
            these technologies to collect and store information when you
            interact with services we offer to our partners, such as advertising
            services. We use google analytics which helps businesses and site
            owners analyze the traffic to their websites and apps.
          </P>
