...
import NavBar from 'app/modules/marketing/web/NavBar';
import { H1, H2, BR, P } from '@expo/html-elements';
      ...
      <View>
        ...
        <View style={styles.wrap}>
          ...
          <P>
            ...
            Throughout the apps, the terms “we”, “us” and “our” refer to
            Skyhitz. Skyhitz offers these apps, including all information, tools
            and services available from these apps to you, the user, conditioned
            upon your acceptance of all terms, conditions, policies and notices
            stated here.
            <BR />
            By visiting our apps and/ or purchasing something from us, you
            ...
            users of the apps, including without limitation users who are
            browsers, vendors, customers, merchants, and/ or contributors of
            content.
            <BR />
            Please read these Terms of Service carefully before accessing or
            using our apps. By accessing or using any part of the apps, you
            agree to be bound by these Terms of Service. If you do not agree to
            all the terms and conditions of this agreement, then you may not
            access the apps or use any services. If these Terms of Service are
          ...
          <P>
            ...
            website. These services may have limited quantities and are subject
            to return or exchange only according to our policy.
            <BR />
            We have made every effort to display as accurately as possible the
            images of our products that appear at the stores. We cannot
            guarantee that your computer monitors display of any color will be
            accurate.
            <BR />
            We reserve the right, but are not obligated, to limit the sales of
            our services to any person, geographic region or jurisdiction. We
            may exercise this right on a case-by-case basis. We reserve the
            right to limit the quantities of any service that we offer. All
          ...
          <P>
            ...
            accordance with the laws of 2nd Floor, Mill Mall Tower Wickhams Cay
            1 Road Town, Tortola, 1110, Virgin Islands, British.
          </P>
